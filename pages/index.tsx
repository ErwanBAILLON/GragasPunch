    ...
    <Layout>
      ...
      <section className="py-12">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg text-gray-700">
            Explore our different varieties of energy drinks, each offering a unique taste and natural energy.
          </p>
        </div>
      </section>
      ...
      <Grid>
        ...
        <BasicBoxContainer color="red">
          ...
          <h2 className="text-xl font-bold text-center">High energy when you need it</h2>
        ...
        <BasicBoxContainer color="sky">
          ...
          <h2 className="text-xl font-bold text-center">Arasgrasa for endurance</h2>
